...
git branch -M main
git remote add origin https://github.com/NIK0gs/pcBoostMax.git
...
```
https://NIK0gs.github.io/pcBoostMax/
```
...
```
https://github.com/NIK0gs/pcBoostMax/releases/download/v2.1.0/GameBoost-2.1.0-x64.exe
```
...
> The site at `NIK0gs.github.io/pcBoostMax/` is what they
...
| Architecture | URL                                                                                   |
| ------------ | ------------------------------------------------------------------------------------- |
| **x64**      | `https://github.com/NIK0gs/pcBoostMax/releases/download/v2.1.0/GameBoost-2.1.0-x64.exe` |
| **x86**      | *leave empty*                                                                          |
...
- **Privacy policy URL**:
  `https://NIK0gs.github.io/pcBoostMax/privacy.html`
- **Support URL**:
  `https://github.com/NIK0gs/pcBoostMax/issues`
...
| Purpose                          | URL                                                                            |
| -------------------------------- | ------------------------------------------------------------------------------ |
| Project landing page             | `https://NIK0gs.github.io/pcBoostMax/`                                    |
| Privacy policy (public)          | `https://NIK0gs.github.io/pcBoostMax/privacy.html`                        |
| Sponsor page (where ads run)     | `https://NIK0gs.github.io/pcBoostMax/sponsor/`                            |
| Banner manifest (consumed by app)| `https://NIK0gs.github.io/pcBoostMax/ads/manifest.json`                   |
| Latest x64 download              | `https://github.com/NIK0gs/pcBoostMax/releases/latest/download/GameBoost-2.1.0-x64.exe` |
| Issue tracker                    | `https://github.com/NIK0gs/pcBoostMax/issues`                             |
| Source                           | `https://github.com/NIK0gs/pcBoostMax`                                    |
