...
class AppConfig:
    ...
    # NOTE: baked at https://NIK0gs.github.io/pcBoostMax/ — change
    # only if forking under a different GitHub user/repo.
    ads_manifest_url: str = "https://NIK0gs.github.io/pcBoostMax/ads/manifest.json"
    ...
    ads_sponsor_url: str = "https://NIK0gs.github.io/pcBoostMax/sponsor/"
